...
//////////////////////////////////////////////////
// STL容器包装
class stl_list implements ICanSerializeObject {
	var $element_type;
	var $size;
	var $value = array();
	...
	function unserialize($bs) {
		...
		$this->value = array();
		for ($i=0; $i<$this->size; $i++) {
			$this->value[] = $bs->popObject($this->element_type);
		}
		return $this->value;
	}
}
...
class stl_map implements ICanSerializeObject {
	var $key_type;
	var $element_type;
	var $size;
	/**
